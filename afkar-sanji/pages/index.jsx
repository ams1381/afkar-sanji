...
import {
    QuestionnaireContainer, MainContainer,
    ...
    return (
        <>
            ...
            <PageBox>
                ...
                <SideBar folders={data?.data} SelectedFolder={SelectedFolder} isopen={SideBarOpen}
                ...
                <Popover
                    content={<AddPopoverContent SelectedFolderNumber={SelectedFolder}
                                                ...
                                                setReadyToCreate={setReadyToCreate}
                    ...
                    <ContentBox>
                        {
                            data?.data && data?.data.length !== 0 ? <MainContainer>
                                    <FolderEditContainer>
                                        <Popover
                                            trigger="click"
                                            content={<FolderPopoverContent RenameFolderState={SetChangeFolderNameState}
                                                                           RenameInput={FolderNameInput}
                                        ...
                                        {RenameFolderLoading ? <TailSpin
                                            ...
                                            <>
                                                <FolderPopoverToggle
                                                    onClick={ChangeFolderName ? folderRenameConfirm : () => setFolderPopover(!FolderPopover)}
                                                    style={FolderName ? {pointerEvents: 'all'} : {pointerEvents: 'none'}}>
                                                    {ChangeFolderName ? <Icon name='GrayCheck' style={{width: 20}}/> :
                                                        <Icon name='Menu'/>}
                                                </FolderPopoverToggle>
                                        ...
                                        <QuestionnaireNameInput type='text'
                                                                onKeyDown={e => e.key === 'Enter' ? folderRenameConfirm() : ''}
                                                                ref={FolderNameInput} error={renameFolderError}
                                                                value={FolderName} onChange={folderNameChangeHandler}
                                            ...
                                            data?.data[SelectedFolder]?.questionnaires.length ? data?.data[SelectedFolder].questionnaires.map((item) =>
                                                ...
                                                : <EmptyFolderContainer>
                                                    ...
                                                    <button onClick={() => setAddQuestionnaireState(true)}>
                                                        {getItem('roleReq') === 'interview-api/interviews' ?
                                                            <p>ایجاد پروژه</p> : <p>ایجاد نظر سنجی</p>}
                                ...
                                : data?.data ? <EmptyFolderContainer>
                                    {getItem('roleReq') === 'interview-api/interviews' ?
                                        <p>برای مدیریت بهتر پروژه ها یک پوشه درست کنید</p> :
                                                ...
                                                <div className="questionnaire_stats">
                                                    <QuestionnaireBodyStat>
                                                        <Skeleton.Input active
                                                                        style={{height: 20, width: 80, minWidth: 20}}/>
                                                        <Skeleton.Input active
                                                                        style={{height: 20, width: 90, minWidth: 20}}/>
                                                    </QuestionnaireBodyStat>
                                                    <QuestionnaireBodyStat>
                                                        <Skeleton.Input active
                                                                        style={{height: 20, width: 70, minWidth: 20}}/>
                                                        <Skeleton.Input active
                                                                        style={{height: 20, width: 110, minWidth: 20}}/>
                                                    </QuestionnaireBodyStat>
                                                </div>
