...
import {
    ...
    CollaborationBody,
    CollaborationHeader,
    CollaborationRecommendSkeleton, CollaborationItemHeader,
    Container,
    FilterBox,
    TabSection, CollaborationInterViewSkeleton
...
export default function ({cookies}) {
    ...
    const items = [{
            ...
            {recommendedData?.isLoading ? (<div style={{
                ...
                <CollaborationRecommendSkeleton>
                    <div className="header">
                        <Skeleton.Button style={{minWidth: 150, width: '100px'}} active
                        />
                        <Skeleton.Input style={{minWidth: 70, width: '100%'}} active
                        />
                    </div>
                    <Skeleton.Input active
                                    style={{height: '20px', minWidth: '20px', width: '140px', marginTop: '20px'}}/>
                    <div className="colum">
                        <Skeleton.Button style={{height: "20px", minWidth: 120, width: '100%'}} active
                        />
                        <Skeleton.Input style={{height: "20px", minWidth: 60, width: '100%'}} active
                        />
                    </div>
        ...
        {
            key: '2', label: 'لیست پرسش‌نامه‌ها', children: (<div id={'scrollableDiv'} style={{
                width: '100%',
                display: 'flex',
                alignItems: 'center',
                gap: '10px',
