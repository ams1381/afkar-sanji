                    ...
                    <UserIconContainer>
                        {
                            Auth.isAdmin ?
                                ...
                                <>
                                    ...
                                    {getItem('role') === 'e' &&
                                        <Icon style={{width: 24, height: 24}} name={'EmployerIcon'}/>}
                                    {getItem('role') === 'i' &&
                                        <Icon style={{width: 24, height: 24}} name={'QuestionerIcon'}/>}
                                    {getItem('role') === 'ie' &&
                                        <Icon style={{width: 24, height: 24}} name={'InterViewerEmployer'}/>}
                                </>
                        }
                        {/*InterViewerEmployer*/}
                    </UserIconContainer>
